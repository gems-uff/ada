 ...
 *
 */
public class SpecialAlgoAgrawalFaster94 {
     ...
     * Default constructor
     */
    public SpecialAlgoAgrawalFaster94() {
    }
     ...
     * @param output the output file path. If null the result is saved in memory
     ...
     * @param m the recursive depth of the call to this method (first time 1,
     * then 2...)
...
//            if (itemset1[i] == 73 || itemset1[i] == 64) {
//                contains = true;
//                break;
//            }
//        }
