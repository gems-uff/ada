 ...
 * @author wallace
 */
public class CMSpadeAlgorithmRun {
...
//        double support = 0.1;
//
//        String inputFile = path + "FILES_TO_MINING/MapDB/data_to_mining_methods_CM.txt";
//
//        String outputFile = path + "FILES_TO_MINING/MapDB/rules_from_mining_methods_CM.txt";
//
...
//            SpecialAlgoCMSPADE specialSpade = new SpecialAlgoCMSPADE(support, true, abstractionCreator);
